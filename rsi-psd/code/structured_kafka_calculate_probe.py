...
bin/spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.3 /home/rsi-psd-vm/Documents/projeto-rsi-psd/code/structured_kafka_calculate_probe.py localhost:9092 subscribe real-time
"""
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("""
        Usage: structured_kafka_calculate_probe.py <bootstrap-servers> <subscribe-type> <topics>
        """, file=sys.stderr)
        sys.exit(-1)
    ...
    df_count_probe = new_df.groupBy().count()
